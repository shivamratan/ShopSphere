...
class $ProductTableTable extends ProductTable
  ...
  late final GeneratedColumnWithTypeConverter<List<String>, String> tags =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<List<String>>($ProductTableTable.$convertertags);
  static const VerificationMeta _brandMeta = const VerificationMeta('brand');
  @override
  late final GeneratedColumn<String> brand = GeneratedColumn<String>(
    'brand',
  ...
  late final GeneratedColumnWithTypeConverter<Dimensions, String> dimensions =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<Dimensions>($ProductTableTable.$converterdimensions);
  static const VerificationMeta _warrantyInformationMeta =
      const VerificationMeta('warrantyInformation');
  @override
  late final GeneratedColumn<String> warrantyInformation =
  ...
  late final GeneratedColumnWithTypeConverter<List<Review>, String> reviews =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<List<Review>>($ProductTableTable.$converterreviews);
  static const VerificationMeta _returnPolicyMeta = const VerificationMeta(
    'returnPolicy',
  );
  @override
  ...
  late final GeneratedColumnWithTypeConverter<Meta, String> meta =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<Meta>($ProductTableTable.$convertermeta);
  @override
  late final GeneratedColumnWithTypeConverter<List<String>, String> images =
      GeneratedColumn<String>(
        'images',
  ...
  Product map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Product(
      ...
      tags: $ProductTableTable.$convertertags.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}tags'],
        )!,
      ...
      reviews: $ProductTableTable.$converterreviews.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}reviews'],
        )!,
      ...
      meta: $ProductTableTable.$convertermeta.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}meta'],
        )!,
...
class ProductTableCompanion extends UpdateCompanion<Product> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (tags.present) {
      map['tags'] = Variable<String>(
        $ProductTableTable.$convertertags.toSql(tags.value),
      );
    }
    if (brand.present) {
      map['brand'] = Variable<String>(brand.value);
    ...
    if (meta.present) {
      map['meta'] = Variable<String>(
        $ProductTableTable.$convertermeta.toSql(meta.value),
      );
    }
    if (images.present) {
      map['images'] = Variable<String>(
...
abstract class _$ShopsphereDb extends GeneratedDatabase {
  ...
  late final ProductDao productDao = ProductDao(this as ShopsphereDb);
  @override
...
class $$ProductTableTableFilterComposer
    extends Composer<_$ShopsphereDb, $ProductTableTable> {
...
class $$ProductTableTableTableManager
    extends
        RootTableManager<
          ...
          (
            Product,
            BaseReferences<_$ShopsphereDb, $ProductTableTable, Product>,
          ),
          Product,
          PrefetchHooks Function()
        > {
  $$ProductTableTableTableManager(_$ShopsphereDb db, $ProductTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$ProductTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$ProductTableTableCreateCompanionBuilder,
      $$ProductTableTableUpdateCompanionBuilder,
      (Product, BaseReferences<_$ShopsphereDb, $ProductTableTable, Product>),
      Product,
      PrefetchHooks Function()
    >;
